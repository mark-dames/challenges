...
class ClockTest < Minitest::Test
  ...
  def test_subtract_minutes_agian
    clock = Clock.at(2,15) - 125
    assert_equal '00:10', clock.to_s
  end
  ...
  def test_wrap_around_backwards2
    clock = Clock.at(0, 15) - 89
    assert_equal '22:46', clock.to_s
  end
end